...
from .repositories import IApiKeyRepository
...
class AuthApiKeyUseCase:
    app_api_key_repository: IApiKeyRepository

    def __init__(self, app_api_key_repository: IApiKeyRepository):
